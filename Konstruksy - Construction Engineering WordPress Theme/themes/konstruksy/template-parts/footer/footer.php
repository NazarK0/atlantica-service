         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="300ms">
                     <div class="copyright-text"><?php $copyright_text = konstruksy_option('footer_copyright', 'Copyright &copy; Konstruksy 2020. All rights reserved.'); echo konstruksy_kses($copyright_text); ?></div>
               </div>
               <div class="col-lg-6 col-md-5">
                     ...
                     <div class="footer-social">
                        <ul>
                        <?php 
                           $social_links = konstruksy_option('footer_social_links',[]);                         
