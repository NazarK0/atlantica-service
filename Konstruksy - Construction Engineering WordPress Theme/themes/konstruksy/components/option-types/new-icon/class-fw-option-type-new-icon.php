...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = KONSTRUKSY_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( KONSTRUKSY_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'konstruksy' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'konstruksy' ),
					'hand'				 => esc_html__( 'Hand Icons', 'konstruksy' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'konstruksy' ),
					'gender'			 => esc_html__( 'Gender Icons', 'konstruksy' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'konstruksy' ),
					'payment'			 => esc_html__( 'Payment Icons', 'konstruksy' ),
					'currency'			 => esc_html__( 'Currency Icons', 'konstruksy' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'konstruksy' ),
					'directional'		 => esc_html__( 'Directional Icons', 'konstruksy' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'konstruksy' ),
					'brand'				 => esc_html__( 'Brand Icons', 'konstruksy' ),
					'medical'			 => esc_html__( 'Medical Icons', 'konstruksy' ),
					'konstruksy-icons'	 => esc_html__( 'konstruksy Icons', 'konstruksy' ),
				),
				'icons'				 => array(
					...
					//konstruksy Icons
					'icon icon-strategicservices_icon1' => array('group' => 'konstruksy-icons'),
					'icon icon-strategicservices_icon3' => array('group' => 'konstruksy-icons'),
					'icon icon-strategicservices_icon4' => array('group' => 'konstruksy-icons'),
					'icon icon-strategicservices_icon5' => array('group' => 'konstruksy-icons'),
					'icon icon-strategicservices_icon6' => array('group' => 'konstruksy-icons'),
					'icon icon-strategicservices_icon7' => array('group' => 'konstruksy-icons'),
					'icon icon-strategicservices_icon8' => array('group' => 'konstruksy-icons'),
					'icon icon-post_icon1' => array('group' => 'konstruksy-icons'),
					'icon icon-post_icon2' => array('group' => 'konstruksy-icons'),
					'icon icon-post_icon3' => array('group' => 'konstruksy-icons'),
					'icon icon-post_icon4' => array('group' => 'konstruksy-icons'),
					'icon icon-post_icon5' => array('group' => 'konstruksy-icons'),
					'icon icon-application_icon' => array('group' => 'konstruksy-icons'),
					'icon icon-opened_positions_icon1' => array('group' => 'konstruksy-icons'),
					'icon icon-opened_positions_icon2' => array('group' => 'konstruksy-icons'),
					'icon icon-about_us_icon1' => array('group' => 'konstruksy-icons'),
					'icon icon-about_us_icon2' => array('group' => 'konstruksy-icons'),
					'icon icon-about_us_icon3' => array('group' => 'konstruksy-icons'),
					'icon icon-about_us_icon4' => array('group' => 'konstruksy-icons'),
					'icon icon-About-2' => array('group' => 'konstruksy-icons'),
					'icon icon-About-3' => array('group' => 'konstruksy-icons'),
					'icon icon-About-4' => array('group' => 'konstruksy-icons'),
					'icon icon-About' => array('group' => 'konstruksy-icons'),
					'icon icon-Banner_current' => array('group' => 'konstruksy-icons'),
					'icon icon-Banner_factory-1' => array('group' => 'konstruksy-icons'),
					'icon icon-Banner_factory' => array('group' => 'konstruksy-icons'),
					'icon icon-Banner_pumpjack' => array('group' => 'konstruksy-icons'),
					'icon icon-Funfacts-2' => array('group' => 'konstruksy-icons'),
					'icon icon-Funfacts-3' => array('group' => 'konstruksy-icons'),
					'icon icon-Funfacts-4' => array('group' => 'konstruksy-icons'),
					'icon icon-Funfacts' => array('group' => 'konstruksy-icons'),
					'icon icon-mobile' => array('group' => 'konstruksy-icons'),
					'icon icon-laptop' => array('group' => 'konstruksy-icons'),
					'icon icon-desktop' => array('group' => 'konstruksy-icons'),
					'icon icon-tablet' => array('group' => 'konstruksy-icons'),
					'icon icon-phone' => array('group' => 'konstruksy-icons'),
					'icon icon-document' => array('group' => 'konstruksy-icons'),
					'icon icon-documents' => array('group' => 'konstruksy-icons'),
					'icon icon-search' => array('group' => 'konstruksy-icons'),
					'icon icon-clipboard' => array('group' => 'konstruksy-icons'),
					'icon icon-newspaper' => array('group' => 'konstruksy-icons'),
					'icon icon-notebook' => array('group' => 'konstruksy-icons'),
					'icon icon-book-open' => array('group' => 'konstruksy-icons'),
					'icon icon-browser' => array('group' => 'konstruksy-icons'),
					'icon icon-calendar' => array('group' => 'konstruksy-icons'),
					'icon icon-presentation' => array('group' => 'konstruksy-icons'),
					'icon icon-picture' => array('group' => 'konstruksy-icons'),
					'icon icon-pictures' => array('group' => 'konstruksy-icons'),
					'icon icon-video' => array('group' => 'konstruksy-icons'),
					'icon icon-camera' => array('group' => 'konstruksy-icons'),
					'icon icon-printer' => array('group' => 'konstruksy-icons'),
					'icon icon-toolbox' => array('group' => 'konstruksy-icons'),
					'icon icon-briefcase' => array('group' => 'konstruksy-icons'),
					'icon icon-wallet' => array('group' => 'konstruksy-icons'),
					'icon icon-gift' => array('group' => 'konstruksy-icons'),
					'icon icon-bargraph' => array('group' => 'konstruksy-icons'),
					'icon icon-grid' => array('group' => 'konstruksy-icons'),
					'icon icon-expand' => array('group' => 'konstruksy-icons'),
					'icon icon-focus' => array('group' => 'konstruksy-icons'),
					'icon icon-edit' => array('group' => 'konstruksy-icons'),
					'icon icon-adjustments' => array('group' => 'konstruksy-icons'),
					'icon icon-ribbon' => array('group' => 'konstruksy-icons'),
					'icon icon-hourglass' => array('group' => 'konstruksy-icons'),
					'icon icon-lock' => array('group' => 'konstruksy-icons'),
					'icon icon-megaphone' => array('group' => 'konstruksy-icons'),
					'icon icon-shield' => array('group' => 'konstruksy-icons'),
					'icon icon-trophy' => array('group' => 'konstruksy-icons'),
					'icon icon-flag' => array('group' => 'konstruksy-icons'),
					'icon icon-map' => array('group' => 'konstruksy-icons'),
					'icon icon-puzzle' => array('group' => 'konstruksy-icons'),
					'icon icon-basket' => array('group' => 'konstruksy-icons'),
					'icon icon-envelope' => array('group' => 'konstruksy-icons'),
					'icon icon-streetsign' => array('group' => 'konstruksy-icons'),
					'icon icon-telescope' => array('group' => 'konstruksy-icons'),
					'icon icon-gears' => array('group' => 'konstruksy-icons'),
					'icon icon-key' => array('group' => 'konstruksy-icons'),
					'icon icon-paperclip' => array('group' => 'konstruksy-icons'),
					'icon icon-attachment' => array('group' => 'konstruksy-icons'),
					'icon icon-pricetags' => array('group' => 'konstruksy-icons'),
					'icon icon-lightbulb' => array('group' => 'konstruksy-icons'),
					'icon icon-layers' => array('group' => 'konstruksy-icons'),
					'icon icon-pencil' => array('group' => 'konstruksy-icons'),
					'icon icon-tools' => array('group' => 'konstruksy-icons'),
					'icon icon-tools-2' => array('group' => 'konstruksy-icons'),
					'icon icon-scissors' => array('group' => 'konstruksy-icons'),
					'icon icon-paintbrush' => array('group' => 'konstruksy-icons'),
					'icon icon-magnifying-glass' => array('group' => 'konstruksy-icons'),
					'icon icon-circle-compass' => array('group' => 'konstruksy-icons'),
					'icon icon-linegraph' => array('group' => 'konstruksy-icons'),
					'icon icon-mic' => array('group' => 'konstruksy-icons'),
					'icon icon-strategy' => array('group' => 'konstruksy-icons'),
					'icon icon-beaker' => array('group' => 'konstruksy-icons'),
					'icon icon-caution' => array('group' => 'konstruksy-icons'),
					'icon icon-recycle' => array('group' => 'konstruksy-icons'),
					'icon icon-anchor' => array('group' => 'konstruksy-icons'),
					'icon icon-profile-male' => array('group' => 'konstruksy-icons'),
					'icon icon-profile-female' => array('group' => 'konstruksy-icons'),
					'icon icon-bike' => array('group' => 'konstruksy-icons'),
					'icon icon-wine' => array('group' => 'konstruksy-icons'),
					'icon icon-hotairballoon' => array('group' => 'konstruksy-icons'),
					'icon icon-globe' => array('group' => 'konstruksy-icons'),
					'icon icon-genius' => array('group' => 'konstruksy-icons'),
					'icon icon-map-pin' => array('group' => 'konstruksy-icons'),
					'icon icon-dial' => array('group' => 'konstruksy-icons'),
					'icon icon-chat' => array('group' => 'konstruksy-icons'),
					'icon icon-heart' => array('group' => 'konstruksy-icons'),
					'icon icon-cloud' => array('group' => 'konstruksy-icons'),
					'icon icon-upload' => array('group' => 'konstruksy-icons'),
					'icon icon-download' => array('group' => 'konstruksy-icons'),
					'icon icon-target' => array('group' => 'konstruksy-icons'),
					'icon icon-hazardous' => array('group' => 'konstruksy-icons'),
					'icon icon-piechart' => array('group' => 'konstruksy-icons'),
					'icon icon-speedometer' => array('group' => 'konstruksy-icons'),
					'icon icon-global' => array('group' => 'konstruksy-icons'),
					'icon icon-compass' => array('group' => 'konstruksy-icons'),
					'icon icon-lifesaver' => array('group' => 'konstruksy-icons'),
					'icon icon-clock' => array('group' => 'konstruksy-icons'),
					'icon icon-aperture' => array('group' => 'konstruksy-icons'),
					'icon icon-quote' => array('group' => 'konstruksy-icons'),
					'icon icon-scope' => array('group' => 'konstruksy-icons'),
					'icon icon-alarmclock' => array('group' => 'konstruksy-icons'),
					'icon icon-refresh' => array('group' => 'konstruksy-icons'),
					'icon icon-happy' => array('group' => 'konstruksy-icons'),
					'icon icon-sad' => array('group' => 'konstruksy-icons'),
					'icon icon-facebook' => array('group' => 'konstruksy-icons'),
					'icon icon-twitter' => array('group' => 'konstruksy-icons'),
					'icon icon-googleplus' => array('group' => 'konstruksy-icons'),
					'icon icon-rss' => array('group' => 'konstruksy-icons'),
					'icon icon-tumblr' => array('group' => 'konstruksy-icons'),
					'icon icon-linkedin' => array('group' => 'konstruksy-icons'),
					'icon icon-dribbble' => array('group' => 'konstruksy-icons'),
					'icon icon-home' => array('group' => 'konstruksy-icons'),
					'icon icon-apartment' => array('group' => 'konstruksy-icons'),
					'icon icon-pencil1' => array('group' => 'konstruksy-icons'),
					'icon icon-magic-wand' => array('group' => 'konstruksy-icons'),
					'icon icon-drop' => array('group' => 'konstruksy-icons'),
					'icon icon-lighter' => array('group' => 'konstruksy-icons'),
					'icon icon-poop' => array('group' => 'konstruksy-icons'),
					'icon icon-sun' => array('group' => 'konstruksy-icons'),
					'icon icon-moon' => array('group' => 'konstruksy-icons'),
					'icon icon-cloud1' => array('group' => 'konstruksy-icons'),
					'icon icon-cloud-upload' => array('group' => 'konstruksy-icons'),
					'icon icon-cloud-download' => array('group' => 'konstruksy-icons'),
					'icon icon-cloud-sync' => array('group' => 'konstruksy-icons'),
					'icon icon-cloud-check' => array('group' => 'konstruksy-icons'),
					'icon icon-database' => array('group' => 'konstruksy-icons'),
					'icon icon-lock1' => array('group' => 'konstruksy-icons'),
					'icon icon-cog' => array('group' => 'konstruksy-icons'),
					'icon icon-trash' => array('group' => 'konstruksy-icons'),
					'icon icon-dice' => array('group' => 'konstruksy-icons'),
					'icon icon-heart1' => array('group' => 'konstruksy-icons'),
					'icon icon-star' => array('group' => 'konstruksy-icons'),
					'icon icon-star-half' => array('group' => 'konstruksy-icons'),
					'icon icon-star-empty' => array('group' => 'konstruksy-icons'),
					'icon icon-flag1' => array('group' => 'konstruksy-icons'),
					'icon icon-envelope1' => array('group' => 'konstruksy-icons'),
					'icon icon-paperclip1' => array('group' => 'konstruksy-icons'),
					'icon icon-inbox' => array('group' => 'konstruksy-icons'),
					'icon icon-eye' => array('group' => 'konstruksy-icons'),
					'icon icon-printer1' => array('group' => 'konstruksy-icons'),
					'icon icon-file-empty' => array('group' => 'konstruksy-icons'),
					'icon icon-file-add' => array('group' => 'konstruksy-icons'),
					'icon icon-enter' => array('group' => 'konstruksy-icons'),
					'icon icon-exit' => array('group' => 'konstruksy-icons'),
					'icon icon-graduation-hat' => array('group' => 'konstruksy-icons'),
					'icon icon-license' => array('group' => 'konstruksy-icons'),
					'icon icon-music-note' => array('group' => 'konstruksy-icons'),
					'icon icon-film-play' => array('group' => 'konstruksy-icons'),
					'icon icon-camera-video' => array('group' => 'konstruksy-icons'),
					'icon icon-camera1' => array('group' => 'konstruksy-icons'),
					'icon icon-picture1' => array('group' => 'konstruksy-icons'),
					'icon icon-book' => array('group' => 'konstruksy-icons'),
					'icon icon-bookmark' => array('group' => 'konstruksy-icons'),
					'icon icon-user' => array('group' => 'konstruksy-icons'),
					'icon icon-users' => array('group' => 'konstruksy-icons'),
					'icon icon-shirt' => array('group' => 'konstruksy-icons'),
					'icon icon-store' => array('group' => 'konstruksy-icons'),
					'icon icon-cart' => array('group' => 'konstruksy-icons'),
					'icon icon-tag' => array('group' => 'konstruksy-icons'),
					'icon icon-phone-handset' => array('group' => 'konstruksy-icons'),
					'icon icon-phone1' => array('group' => 'konstruksy-icons'),
					'icon icon-pushpin' => array('group' => 'konstruksy-icons'),
					'icon icon-map-marker' => array('group' => 'konstruksy-icons'),
					'icon icon-map1' => array('group' => 'konstruksy-icons'),
					'icon icon-location' => array('group' => 'konstruksy-icons'),
					'icon icon-calendar-full' => array('group' => 'konstruksy-icons'),
					'icon icon-keyboard' => array('group' => 'konstruksy-icons'),
					'icon icon-spell-check' => array('group' => 'konstruksy-icons'),
					'icon icon-screen' => array('group' => 'konstruksy-icons'),
					'icon icon-smartphone' => array('group' => 'konstruksy-icons'),
					'icon icon-tablet1' => array('group' => 'konstruksy-icons'),
					'icon icon-laptop1' => array('group' => 'konstruksy-icons'),
					'icon icon-laptop-phone' => array('group' => 'konstruksy-icons'),
					'icon icon-power-switch' => array('group' => 'konstruksy-icons'),
					'icon icon-bubble' => array('group' => 'konstruksy-icons'),
					'icon icon-heart-pulse' => array('group' => 'konstruksy-icons'),
					'icon icon-construction' => array('group' => 'konstruksy-icons'),
					'icon icon-pie-chart' => array('group' => 'konstruksy-icons'),
					'icon icon-chart-bars' => array('group' => 'konstruksy-icons'),
					'icon icon-gift1' => array('group' => 'konstruksy-icons'),
					'icon icon-diamond' => array('group' => 'konstruksy-icons'),
					'icon icon-dinner' => array('group' => 'konstruksy-icons'),
					'icon icon-coffee-cup' => array('group' => 'konstruksy-icons'),
					'icon icon-leaf' => array('group' => 'konstruksy-icons'),
					'icon icon-paw' => array('group' => 'konstruksy-icons'),
					'icon icon-rocket' => array('group' => 'konstruksy-icons'),
					'icon icon-briefcase1' => array('group' => 'konstruksy-icons'),
					'icon icon-bus' => array('group' => 'konstruksy-icons'),
					'icon icon-car' => array('group' => 'konstruksy-icons'),
					'icon icon-train' => array('group' => 'konstruksy-icons'),
					'icon icon-bicycle' => array('group' => 'konstruksy-icons'),
					'icon icon-wheelchair' => array('group' => 'konstruksy-icons'),
					'icon icon-select' => array('group' => 'konstruksy-icons'),
					'icon icon-earth' => array('group' => 'konstruksy-icons'),
					'icon icon-smile' => array('group' => 'konstruksy-icons'),
					'icon icon-sad1' => array('group' => 'konstruksy-icons'),
					'icon icon-neutral' => array('group' => 'konstruksy-icons'),
					'icon icon-mustache' => array('group' => 'konstruksy-icons'),
					'icon icon-alarm' => array('group' => 'konstruksy-icons'),
					'icon icon-bullhorn' => array('group' => 'konstruksy-icons'),
					'icon icon-volume-high' => array('group' => 'konstruksy-icons'),
					'icon icon-volume-medium' => array('group' => 'konstruksy-icons'),
					'icon icon-volume-low' => array('group' => 'konstruksy-icons'),
					'icon icon-volume' => array('group' => 'konstruksy-icons'),
					'icon icon-mic1' => array('group' => 'konstruksy-icons'),
					'icon icon-hourglass1' => array('group' => 'konstruksy-icons'),
					'icon icon-undo' => array('group' => 'konstruksy-icons'),
					'icon icon-redo' => array('group' => 'konstruksy-icons'),
					'icon icon-sync' => array('group' => 'konstruksy-icons'),
					'icon icon-history' => array('group' => 'konstruksy-icons'),
					'icon icon-clock1' => array('group' => 'konstruksy-icons'),
					'icon icon-download1' => array('group' => 'konstruksy-icons'),
					'icon icon-upload1' => array('group' => 'konstruksy-icons'),
					'icon icon-enter-down' => array('group' => 'konstruksy-icons'),
					'icon icon-exit-up' => array('group' => 'konstruksy-icons'),
					'icon icon-bug' => array('group' => 'konstruksy-icons'),
					'icon icon-code' => array('group' => 'konstruksy-icons'),
					'icon icon-link' => array('group' => 'konstruksy-icons'),
					'icon icon-unlink' => array('group' => 'konstruksy-icons'),
					'icon icon-thumbs-up' => array('group' => 'konstruksy-icons'),
					'icon icon-thumbs-down' => array('group' => 'konstruksy-icons'),
					'icon icon-magnifier' => array('group' => 'konstruksy-icons'),
					'icon icon-cross' => array('group' => 'konstruksy-icons'),
					'icon icon-menu' => array('group' => 'konstruksy-icons'),
					'icon icon-list' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-up' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-down' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-left' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-right' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-up' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-down' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-left' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-right' => array('group' => 'konstruksy-icons'),
					'icon icon-move' => array('group' => 'konstruksy-icons'),
					'icon icon-warning' => array('group' => 'konstruksy-icons'),
					'icon icon-question-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-menu-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-checkmark-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-cross-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-plus-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-circle-minus' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-up-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-down-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-left-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-arrow-right-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-up-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-down-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-left-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-chevron-right-circle' => array('group' => 'konstruksy-icons'),
					'icon icon-crop' => array('group' => 'konstruksy-icons'),
					'icon icon-frame-expand' => array('group' => 'konstruksy-icons'),
					'icon icon-frame-contract' => array('group' => 'konstruksy-icons'),
					'icon icon-layers1' => array('group' => 'konstruksy-icons'),
					'icon icon-funnel' => array('group' => 'konstruksy-icons'),
					'icon icon-text-format' => array('group' => 'konstruksy-icons'),
					'icon icon-text-size' => array('group' => 'konstruksy-icons'),
					'icon icon-bold' => array('group' => 'konstruksy-icons'),
					'icon icon-italic' => array('group' => 'konstruksy-icons'),
					'icon icon-underline' => array('group' => 'konstruksy-icons'),
					'icon icon-strikethrough' => array('group' => 'konstruksy-icons'),
					'icon icon-highlight' => array('group' => 'konstruksy-icons'),
					'icon icon-text-align-left' => array('group' => 'konstruksy-icons'),
					'icon icon-text-align-center' => array('group' => 'konstruksy-icons'),
					'icon icon-text-align-right' => array('group' => 'konstruksy-icons'),
					'icon icon-text-align-justify' => array('group' => 'konstruksy-icons'),
					'icon icon-line-spacing' => array('group' => 'konstruksy-icons'),
					'icon icon-indent-increase' => array('group' => 'konstruksy-icons'),
					'icon icon-indent-decrease' => array('group' => 'konstruksy-icons'),
					'icon icon-page-break' => array('group' => 'konstruksy-icons'),
					'icon icon-hand' => array('group' => 'konstruksy-icons'),
					'icon icon-pointer-up' => array('group' => 'konstruksy-icons'),
					'icon icon-pointer-right' => array('group' => 'konstruksy-icons'),
					'icon icon-pointer-down' => array('group' => 'konstruksy-icons'),
					'icon icon-pointer-left' => array('group' => 'konstruksy-icons'),
					'icon icon-vplay' => array('group' => 'konstruksy-icons'),
					'icon icon-newsletter' => array('group' => 'konstruksy-icons'),
					'icon icon-coins-2' => array('group' => 'konstruksy-icons'),
					'icon icon-commerce-2' => array('group' => 'konstruksy-icons'),
					'icon icon-monitor' => array('group' => 'konstruksy-icons'),
					'icon icon-graphic-3' => array('group' => 'konstruksy-icons'),
					'icon icon-business' => array('group' => 'konstruksy-icons'),
					'icon icon-graphic-2' => array('group' => 'konstruksy-icons'),
					'icon icon-commerce-1' => array('group' => 'konstruksy-icons'),
					'icon icon-hammer' => array('group' => 'konstruksy-icons'),
					'icon icon-graphic-1' => array('group' => 'konstruksy-icons'),
					'icon icon-graphic' => array('group' => 'konstruksy-icons'),
					'icon icon-justice-1' => array('group' => 'konstruksy-icons'),
					'icon icon-line' => array('group' => 'konstruksy-icons'),
					'icon icon-money-3' => array('group' => 'konstruksy-icons'),
					'icon icon-chart' => array('group' => 'konstruksy-icons'),
					'icon icon-commerce' => array('group' => 'konstruksy-icons'),
					'icon icon-agenda' => array('group' => 'konstruksy-icons'),
					'icon icon-money-2' => array('group' => 'konstruksy-icons'),
					'icon icon-justice' => array('group' => 'konstruksy-icons'),
					'icon icon-money-1' => array('group' => 'konstruksy-icons'),
					'icon icon-money' => array('group' => 'konstruksy-icons'),
					'icon icon-technology' => array('group' => 'konstruksy-icons'),
					'icon icon-coins-1' => array('group' => 'konstruksy-icons'),
					'icon icon-coins' => array('group' => 'konstruksy-icons'),
					'icon icon-left-arrow' => array('group' => 'konstruksy-icons'),
					'icon icon-bank' => array('group' => 'konstruksy-icons'),
					'icon icon-calculator' => array('group' => 'konstruksy-icons'),
					'icon icon-chart1' => array('group' => 'konstruksy-icons'),
					'icon icon-chart2' => array('group' => 'konstruksy-icons'),
					'icon icon-checked' => array('group' => 'konstruksy-icons'),
					'icon icon-clock2' => array('group' => 'konstruksy-icons'),
					'icon icon-comment' => array('group' => 'konstruksy-icons'),
					'icon icon-comments' => array('group' => 'konstruksy-icons'),
					'icon icon-consult' => array('group' => 'konstruksy-icons'),
					'icon icon-consut2' => array('group' => 'konstruksy-icons'),
					'icon icon-deal' => array('group' => 'konstruksy-icons'),
					'icon icon-download2' => array('group' => 'konstruksy-icons'),
					'icon icon-envelope2' => array('group' => 'konstruksy-icons'),
					'icon icon-euro' => array('group' => 'konstruksy-icons'),
					'icon icon-folder' => array('group' => 'konstruksy-icons'),
					'icon icon-invest' => array('group' => 'konstruksy-icons'),
					'icon icon-loan' => array('group' => 'konstruksy-icons'),
					'icon icon-map-marker1' => array('group' => 'konstruksy-icons'),
					'icon icon-mutual-fund' => array('group' => 'konstruksy-icons'),
					'icon icon-percent' => array('group' => 'konstruksy-icons'),
					'icon icon-phone2' => array('group' => 'konstruksy-icons'),
					'icon icon-pie-chart1' => array('group' => 'konstruksy-icons'),
					'icon icon-play' => array('group' => 'konstruksy-icons'),
					'icon icon-left-arrow2' => array('group' => 'konstruksy-icons'),
					'icon icon-savings' => array('group' => 'konstruksy-icons'),
					'icon icon-search1' => array('group' => 'konstruksy-icons'),
					'icon icon-tag1' => array('group' => 'konstruksy-icons'),
					'icon icon-tags' => array('group' => 'konstruksy-icons'),
					'icon icon-tax' => array('group' => 'konstruksy-icons'),
					'icon icon-quote1' => array('group' => 'konstruksy-icons'),
					'icon icon-right-arrow2' => array('group' => 'konstruksy-icons'),
