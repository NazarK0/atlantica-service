!(function (n) {
      ...
      if (0 !== s.length)
        for (o = l ? t.aoData.length : u, l = l ? 0 : i; l < o; l++) {
          ...
          if ((null === f.nTr && g(t, c), (c = f.nTr), 0 !== r)) {
            var d = a[n % r]
            f._sRowStripe != d &&
              (P(c).removeClass(f._sRowStripe).addClass(d), (f._sRowStripe = d))
          }
  ...
  function G(n) {
    var t = n.oClasses,
      ...
      o = n.aanFeatures,
      i = (
        '<input style="display:none" type="search" class="' + t.sFilterInput + '"/>'
        // + '<input type="search" class="' + t.sFilterInput + '"/>'
        ),
    ...
    (Vt.register = Xt = function (t, e) {
      if (P.isArray(t))
        ...
        for (n = 0, a = i.length; n < a; n++) {
          ...
          s ||
            ((s = { name: r, val: {}, methodExt: [], propExt: [] }), l.push(s)),
              ...
              for (n = 0, a = e.length; n < a; n++)
                if (((o = e[n]), P.isArray(o)))
                  ...
                  switch (((f = null), (d = ''), o)) {
                    ...
                    case 'next':
                      ;(f = p.sNext),
                        (d = o + (u < c - 1 ? '' : ' ' + h.sPageButtonDisabled))
                      break
                    case 'last':
                      ;(f = p.sLast),
                        (d = o + (u < c - 1 ? '' : ' ' + h.sPageButtonDisabled))
